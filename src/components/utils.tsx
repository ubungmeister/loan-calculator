...
export const handleMortgageDataChange=(amountBorrow:number,interest:number,yearPay:number,monthlyRate:number)=>{
    ...
    let monthDataObject = [{
        ...
        principalRepaidByYear:0,
        interestRepaidByYear:0
    }];
    ...
    yearPay = yearPay*12
    let counter = 0
    let principalRepaidByYear = 0
    let interestRepaidByYear = 0
    ...
    for(let i = 1; i <= yearPay; i++) {
        ...
        // acc by each Year interest
        interestRepaidByYear = interestRepaidByYear + monthInterestPaid
         //monthly principal
        ...
        // acc by each Year principal
        principalRepaidByYear = principalRepaidByYear + monthPrincipalPaid
        ...
        monthDataObject.push({
            ...
            principalRepaidByYear: principalRepaidByYear,
            interestRepaidByYear:interestRepaidByYear
        });
        counter = counter +1
        if(counter % 12 === 0){
            principalRepaidByYear = 0
